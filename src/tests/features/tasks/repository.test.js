...
import { loadTasks, saveTasks } from '../../../features/tasks/repository.js';
...
describe('repository', () => {
  ...
  describe('loadTasks', () => {
    ...
    it('returns parsed tasks when data exists', () => {
      const tasks = [{ id: '1', text: 'Buy milk', completed: false, priority: 'medium' }];
  ...
  describe('saveTasks', () => {
    it('persists tasks to localStorage', () => {
      const tasks = [{ id: '1', text: 'Code', completed: true, priority: 'high' }];
      saveTasks(tasks);
